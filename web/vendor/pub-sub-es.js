/* pub-sub-es@3.0.0 vendored as a classic script exposing window.createPubSub.
 * Source: https://cdn.jsdelivr.net/npm/pub-sub-es@3.0.0/dist/index.js (MIT, Fritz Lekschas).
 * Only change: the two ESM `export` lines are replaced with a browser-global
 * assignment so regl-scatterplot's UMD build can read `createPubSub`.
 * Regenerate via pipeline/vendor_libs.py. */
(function (root) {
/**
